...
public class PingPongTest {
    ...
    @Test
    public void runPingPong_countToGivenNumber_ArrayList(){
        PingPong testPingPong = new PingPong();
        List<Object> expectedOutPut = new ArrayList<Object>();
        expectedOutPut.add(1);
    ...
    @Test
    public void runPingPong_replaceMultiplesOfThree_ArrayList(){
        PingPong testPingPong = new PingPong();
        List <Object> expectedOutput = new ArrayList<Object>();
        expectedOutput.add(1);
        expectedOutput.add(2);
    ...
    @Test
    public void runPingPong_replaceMultiplesOfFive_ArrayList(){
        PingPong testPingPong = new PingPong();
        List<Object> expectedOutPut = new ArrayList<Object>();
        expectedOutPut.add(1);
        expectedOutPut.add(2);
